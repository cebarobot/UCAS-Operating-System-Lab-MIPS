...
struct task_info task2_10 = {"task10", (uint64_t)&drawing_task2, USER_PROCESS, 2};
struct task_info task2_10_1 = {"task10", (uint64_t)&drawing_task2_1, USER_PROCESS, 3};
struct task_info *sched2_tasks[16] = {&task2_8, &task2_9, &task2_10, &task2_10_1};
int num_sched2_tasks = 4;

struct task_info task2_11 = {"task8", (uint64_t)&cost_task, KERNEL_PROCESS, 1};
struct task_info *cost_tasks[16] = {&task2_11};
int num_cost_tasks = 1;